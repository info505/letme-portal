...
export async function loader({ request }) {
  ...
  const customers = await prisma.portalUser.findMany({
    orderBy: [{ isActive: "asc" }, { companyName: "asc" }],
    select: {
      id: true,
      companyName: true,
      firstName: true,
...
function getSuccessMessage(success) {
  ...
  if (success === "approved") return "Kundenkonto wurde freigegeben.";
...
function CustomerCard({ customer }) {
  ...
  return (
    <div
      style={{
        ...styles.customerItem,
        ...(isPending ? styles.customerItemPending : {}),
      }}
    >
        ...
        {!customer.isAdmin ? (
          <Form method="post">
            ...
            <button type="submit" style={styles.smallBtn}>
              {customer.isActive ? "Sperren" : "Aktivieren"}
            </button>
          </Form>
        ) : null}
...
export default function AdminCustomersPage() {
  ...
  return (
    <AdminLayout
      title="Firmenkunden"
      subtitle="Firmenkonten prüfen, freigeben und verwalten."
      user={user}
    >
      ...
      <div style={styles.grid}>
        ...
        <div style={styles.stats}>
          ...
          <div style={styles.stat}>
            <div style={styles.statLabel}>Wartet auf Freigabe</div>
          ...
          <div style={styles.stat}>
            <div style={styles.statLabel}>Gesperrt</div>
